...
class Story {
  ...
  static renderGlum() {
    ...
    const story = document.querySelectorAll('#story')
     ...
     section_1.innerHTML = '<div><img src=img/glum1.svg class="svg"><div class=glum1>today isn’t the best</div></div>'
    ...
    const userList = document.querySelector('.user-label')
  ...
  static renderMeh() {
    div.innerHTML = ''
    section_1.innerHTML = '<div class="sec1"><img src=img/meh1.svg><div class=meh1>meh</div></div>'
    section_2.innerHTML = '<div><img src=img/meh2.svg><div class=meh2>meh</div></div>'
    section_3.innerHTML = '<div><img src=img/meh3.svg><div class=meh3>meh</div></div>'
